    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-32">
        <div className="">
          ...
          >
            Premium sanitaryware manufactured in India, engineered for
            durability, hygiene, and modern architectural requirements — trusted
            by global distributors, project developers, and trade partners.
          </motion.p>
          ...
          >
            Megica Sanitaryware is a manufacturing-driven brand delivering
            export-quality bathroom solutions for residential, commercial,
            hospitality, and infrastructure projects. Backed by structured
            processes, strict quality control, and scalable production, we
            support long-term sourcing partnerships across multiple regions.
          </motion.p>
          ...
          <motion.div
            ...
            className="mt-14 w-full rounded-3xl border border-white/10 bg-linear-to-r from-bg-main/30 to-brand-primary/10 px-8 py-10 backdrop-blur-sm
  "
          >
            <div className="grid gap-10 lg:grid-cols-3 items-center">
              ...
              <div className="col-span-2">
                <h2 className="text-4xl mb-8 tracking-widest text-text-inverse">
                  Indian Manufacturing Excellence. Global Supply Confidence.
                </h2>

                <div className="grid gap-2 sm:grid-cols-2">
                  {[
                    "Export-compliant finishing & packaging",
                    "Consistent quality across batches",
                    "Bulk & project-ready production capacity",
              ...
              <div className="flex flex-wrap gap-4 lg:col-span-1 col-span-2 lg:justify-end">
                <Link
                  href="/sanitaryware"
                  className="inline-flex items-center justify-center text-center rounded-lg bg-brand-accent px-8 py-4 text-sm font-semibold uppercase tracking-wider text-black shadow-card transition-transform duration-300 hover:scale-[1.03]"
                >
