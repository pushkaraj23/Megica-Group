...
export default function BathroomFittingsLayout({ children }) {
  return (
    <>
      ...
      <section className="relative bg-bg-dark text-inverse overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-16">
          ...
          <h1 className="mt-3 font-heading text-3xl sm:text-4xl text-text-inverse lg:text-5xl font-extrabold">
            Bathroom Fittings
          </h1>

          <p className="mt-4 max-w-3xl text-bg-light text-base sm:text-lg leading-relaxed">
            Precision-engineered bathroom fittings designed for durability,
            water efficiency, and global compliance. Built for residential,
      ...
      <div className="sticky top-16 z-40 bg-bg-main/90 backdrop-blur border-b border-light">
        <div className="mx-auto max-w-7xl px-6">
          <nav className="flex gap-6 overflow-x-auto py-3 text-sm font-semibold text-text-secondary">
            <SectionTab href="/bathroom-fittings">Overview</SectionTab>
            <SectionTab href="/bathroom-fittings/products">Products</SectionTab>
            <SectionTab href="/bathroom-fittings/about">About</SectionTab>
            <SectionTab href="/bathroom-fittings/contact">Enquiry</SectionTab>
          </nav>
        </div>
      </div>
