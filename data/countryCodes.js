/**
 * Country names and dial codes for phone number inputs.
 * Sorted by country name. Dropdown options are built dynamically from this list.
 */
export const COUNTRY_CODES = [
  ...
  { name: "Haiti", code: "+509" },
  { name: "Holy See (Vatican City)", code: "+379" },
  ...
  { name: "South Georgia and South Sandwich Islands", code: "+500" },
